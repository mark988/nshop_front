...
export default function AllProductsPage() {
    ...
    '& .MuiTab-root': {
      ...
      '&:not(:last-child)': {
        '&:after': {
          ...
          width: 1,
          height: 16, // 固定高度
          backgroundColor: 'rgba(F, 0, 0, 0.12)',
        }
      },
      '&:hover': {
        backgroundColor: 'transparent', // 移除悬停背景色
        color: theme.palette.primary.main,
      },
      '&.Mui-selected': {
        backgroundColor: 'transparent', // 移除选中背景色
        color: theme.palette.primary.main,
        fontWeight: 700,
        // 移除阴影
        boxShadow: 'none',
  ...
  return (
    ...
    <InputLabel sx={{ fontWeight: 300, color: 'grey.700' }}>
    Sort
    </InputLabel>
    <Select
    label="排序"
    ...
    sx={{
      fontWeight: 500,
      color: 'grey.800',
      '& .Mui-selected': { color: 'primary.main', fontWeight: 300 },
    }}
    MenuProps={{
      PaperProps: {
    ...
    borderRadius: 1,
    boxShadow: '0 1px 4px rgba(60,60,60,0.04)',
    '& .MuiInputLabel-root': { fontWeight: 300 },
    '& .MuiOutlinedInput-root': {
      background: 'white',
      borderRadius: 1,
      '& fieldset': { borderColor: 'grey.100' },
